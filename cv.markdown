...
<span class="entry-detail">*Software engineer*</span><br/>
<span class="entry-detail entry-blurb">Back- and middle-office trading workflows and batch jobs (fees, FX), plus second-level support.</span>
<span class="entry-detail">**Activities**: `software architecture`, `coding`, `bug-fixing`, `2nd-level support`</span><br/>
<span class="entry-detail">**Language**: `C#`</span><br/>
<span class="entry-detail">**Frameworks**: `WinForms`, `DevExpress`, `Dapper`, `AutoMapper`, `gRPC`, `ASP.NET`, `Postgres`</span>

### <span class="entry-title"><img class="entry-logo" src="{{ '/assets/images/logos/aws.svg' | relative_url }}"/> Amazon Web Services</span> <span class="entry-meta">[Mar 2016 – Oct 2016]</span>
<span class="entry-detail">*Software Development Engineer*</span><br/>
<span class="entry-detail entry-blurb">Active network monitoring services and tools; on-call rotation and recruiting support.</span>
<span class="entry-detail">**Activities**: `software architecture`, `coding`, `bug-fixing`, `on-call support`, `recruiting`</span><br/>
<span class="entry-detail">**Languages**: `C++`, `Java`, `Python`, `Ruby`</span><br/>
<span class="entry-detail">**Frameworks**: `Ruby on Rails`, `Guice`, `Protobuf`</span>

### <span class="entry-title"><img class="entry-logo" src="{{ '/assets/images/logos/daon.webp' | relative_url }}"/> Daon <span class="entry-meta"><a href="https://www.daon.com/products/identityx/">IdentityX</a></span></span> <span class="entry-meta">[Oct 2015 – Mar 2016]</span>
<span class="entry-detail">*Software engineer*</span><br/>
...
<span class="entry-detail">*Software engineer*</span><br/>
<span class="entry-detail entry-blurb">Mobile websites and communication protocols for Italian telecom providers.</span>
<span class="entry-detail">**Activities**: `coding`, `bug-fixing`, `database management`</span><br/>
...
<span class="entry-detail entry-row">**Grade** <span class="entry-row-value">103/110</span></span><br/><br/>
...
<span class="entry-detail entry-row">**Dissertation** <span class="entry-row-value">A publish/subscribe system based on Gmail (in Italian)</span></span>
<span class="entry-detail entry-row">**Grade** <span class="entry-row-value">106/110</span></span>

### <span class="entry-title"><img class="entry-logo" src="{{ '/assets/images/logos/galilei.png' | relative_url }}"/> I.T.I.S. Galileo Galilei</span> <span class="entry-meta">[Sep 1997 – Jun 2003]</span>
<span class="entry-detail">*High school diploma in computer science*</span><br/>
