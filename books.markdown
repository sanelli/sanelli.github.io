...
|-----------------------------------|-----------------------------------|------|------|-----------|
| [The Princess Bride](https://en.wikipedia.org/wiki/The_Princess_Bride_(novel))| [William Goldman](https://en.wikipedia.org/wiki/William_Goldman) | <code>English</code> | 1973 | <nobr><code>fantasy</code>, <code>romance</code>,<br/><code>adventure</code>, <code>metafiction</code></nobr> |
